    ...
    return (
        <div className="quick-action-layer" ref={layerRef}>
            <button
                ...
                style={{ ...(floatingPosition ? { left: floatingPosition.left, top: floatingPosition.top } : {}), background: "#E7E9F5", color: "#27483D", border: "2px solid #6E789C", boxShadow: "0 4px 14px rgba(39,72,61,.22), 0 0 0 3px rgba(226,230,246,.72), inset 0 1px 0 rgba(255,255,255,.82)", transition: "transform 120ms ease, box-shadow 120ms ease" }}
            >
            ...
            {open ? (
                <div
                    ...
                    style={{ ...popoverStyle, background: "#F0F1F8", color: "#263F37", backdropFilter: "blur(18px)", WebkitBackdropFilter: "blur(18px)", border: "2px solid #7C86A8", boxShadow: "0 0 0 3px rgba(236,238,249,.88), 0 12px 36px rgba(39,72,61,.22), inset 0 1px 0 rgba(255,255,255,.84)", boxSizing: "border-box", isolation: "isolate" }}
                    role="dialog"
                    aria-label="快捷操作"
